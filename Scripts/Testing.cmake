...
FOREACH(file ${UnitTests})
	...
	SET_TARGET_PROPERTIES(${target} PROPERTIES COMPILE_FLAGS "-I${CMAKE_TESTING_DIRECTORY}/Source -I${CMAKE_SOURCE_DIR} -DTEST -DTESTDIR=\"\\\"${CMAKE_TESTING_DIRECTORY}/Runtime\\\"\"")
...
FOREACH(file ${ManualTests})
	IF(MANUAL_TEST_${file})
		...
		SET_TARGET_PROPERTIES(${target} PROPERTIES COMPILE_FLAGS "-I${CMAKE_TESTING_DIRECTORY}/Source -DTEST -I${CMAKE_SOURCE_DIR} -DTESTDIR=\"\\\"${CMAKE_TESTING_DIRECTORY}/Runtime\\\"\"")
		TARGET_LINK_LIBRARIES(${target} Gorgon)
