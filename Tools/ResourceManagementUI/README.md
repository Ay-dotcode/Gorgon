...
This is a tool built with Gorgon to help import Resource that will be needed in game developement. With this UI you can set the size and location to import resources too.


## Resource Managment UI use
