...
int main() {
    ...
    */
    ...
    //points.push_back({{14.44,30.08 }, {20.59,24.64 }, {14.44,19.2 }, {8.32,24.64}, {14.44,30.08 }}); 
    points.push_back({{21.3,25.4}, {21.3,23.9}, {15.1,18.5}, {13.8,18.5}, {7.7,23.9}, {7.7,25.4}, {13.8,30.8}, {15.1,30.8}, {21.3,25.4}, });
    points.push_back({{19.1,24.6}, {14.4,28.7}, {9.8,24.6}, {14.4,20.5}, {19.1,24.6}, });
    
    for(auto &pl : points) {
        for(auto &p : pl) {
            p = (p-Geometry::Pointf(7, 18));
        }
    }
    
    //CGI::DrawLines(bmp.GetData(), points, 2, CGI::SolidFill<>(0xffffffff));
