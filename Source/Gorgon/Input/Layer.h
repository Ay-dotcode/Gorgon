...
namespace Gorgon { namespace Input {
		...
		protected:
			...
			virtual void propagate_mouseevent(Input::Mouse::EventType event, Geometry::Point location, Input::Mouse::Button button, float amount, MouseHandler &handlers) override;
