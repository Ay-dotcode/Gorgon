...
namespace gge { namespace widgets {
	...
	namespace regionresource_prvt {
		void setregionprovider(vector<Animation *> &anims, RectangularGraphic2DSequenceProvider *&obj, int id) {
	...
	RegionResource *LoadRegionResource(resource::File& File, std::istream &Data, int Size) {
		...
		RectangularGraphic2DSequenceProvider *tli=NULL,         *tri=NULL;
		RectangularGraphic2DSequenceProvider *bli=NULL,         *bri=NULL;
		SGuid mask;
		RegionResource::TilingInfo tile;
		tile.Top=true;
		tile.Left=true;
		tile.Bottom=true;
		tile.Right=true;
		...
		regionresource_prvt::setregionprovider(anims, t , 0);
		regionresource_prvt::setregionprovider(anims, tl, 1);
		regionresource_prvt::setregionprovider(anims, tr, 2);

		regionresource_prvt::setregionprovider(anims, c, 3);
		regionresource_prvt::setregionprovider(anims, l, 4);
		regionresource_prvt::setregionprovider(anims, r, 5);

		regionresource_prvt::setregionprovider(anims, b , 6);
		regionresource_prvt::setregionprovider(anims, bl, 7);
		regionresource_prvt::setregionprovider(anims, br, 8);

		regionresource_prvt::setregionprovider(anims, tli, 9);
		regionresource_prvt::setregionprovider(anims, tri, 10);
		regionresource_prvt::setregionprovider(anims, bli, 11);
		regionresource_prvt::setregionprovider(anims, bri, 12);

		region=new RegionResource(*tl, *t, *tr, *l, *c, *r, *bl, *b, *br, *tli, *tri, *bli, *bri, tile);
		region->guid=g;

		for(auto i=anims.begin(); i!=anims.end(); i++) {
			region->Subitems.Add(*i, region->Subitems.HighestOrder()+1);
		}
	...
	void Region::drawin(graphics::ImageTarget2D& Target, int X, int Y, int W, int H) const {
